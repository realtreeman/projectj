...
<div class="board_wrap">
	<div class="container">
		...
		<div class="title_regi_button clearfix">
			<h1 class="category_board">${category}</h1>
		...
		<div class="searching_bottom">
			<form action="${contextPath}/board/list/${category}" id="listForm" class="d-flex justify-content-end">
				<div>
					<select class="searching_type" name="type">
